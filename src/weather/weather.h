...
//!< This value means frostbite occurs at the warmest temperature of 1C. If changed, the temp_conv
//!< calculation should be reexamined.
 ...
 * Used for redrawing the view coordinates overwritten by the previous frame's animation bits
 * (raindrops, snowflakes, etc,) and to draw this frame's weather animation.
